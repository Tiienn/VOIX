        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <h3 className="text-2xl font-bold text-gradient">VOIX</h3>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transforming businesses with cutting-edge AI voice solutions. 
              We help companies automate customer interactions, reduce costs, 
              and enhance customer satisfaction through intelligent voice technology.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-300">
                Get the latest insights on AI technology and industry trends delivered to your inbox.
              </p>
            </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} VOIX. All rights reserved.
            </div>
